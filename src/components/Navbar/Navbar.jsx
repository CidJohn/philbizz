...
import KTV_JTV2 from "../../assets/img/icon/KTV_JTV2.png";
import MASSAGE from "../../assets/img/icon/MASSAGE2.png";
            ...
            <div className=' flex items-baseline space-x-1 relative gap-5  '>
              ...
              <div className='hidden lg:flex items-center justify-center flex-col cursor-pointer'>
                <HeadlessDropdown
                  ...
                  className='fira-sans-bold text-slate-600 cursor-pointer flex items-center justify-center flex-col '
                >
                  <div className='flex items-center justify-center space-x-1 relative gap-2 p-4'>
                    <div className='flex flex-col items-center justify-center gap-3'>
                      <img src={KTV_JTV2} alt='' className='px-4 w-20 h-auto' />
                      <p className='fira-sans-bold text-slate-600'>Ktv/Jtv</p>
                    </div>
                    <div className='flex flex-col items-center justify-center gap-3'>
                      <img src={MASSAGE} alt='' className='px-4 w-20 h-auto' />
                      <p className='fira-sans-bold  text-slate-600'>Massage</p>
                    </div>
                  </div>
                </HeadlessDropdown>
              </div>
